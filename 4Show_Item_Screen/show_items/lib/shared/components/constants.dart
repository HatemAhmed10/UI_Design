...
List<AssetImage> KImage = [
  AssetImage(ImageAssets.Destination),
  AssetImage(ImageAssets.English),
  AssetImage(ImageAssets.Mathematics),
  AssetImage(ImageAssets.Presentation),
  AssetImage(ImageAssets.Science),
  AssetImage(ImageAssets.Science2),
];
